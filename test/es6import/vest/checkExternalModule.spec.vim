...
Context tsuquyomi#es6import#checkExternalModule(moduleName, file)
  ...
  It returns 0 when the file does not have the given module
    ...
    let code = tsuquyomi#es6import#checkExternalModule('__NO_MODULE__', s:input_file)
    Should code == 0
  ...
  It returns 1 when the file has single-quated module
    call tsuquyomi#tsClient#tsOpen(s:input_file)
    let code = tsuquyomi#es6import#checkExternalModule('external-module', s:input_file)
    Should code == 1
    call tsuquyomi#tsClient#stopTss()
  End
  ...
  It returns 1 when the file has a double-quated module
    call tsuquyomi#tsClient#tsOpen(s:input_file)
    let code = tsuquyomi#es6import#checkExternalModule('external-module/alt', s:input_file)
    Should code == 1
    call tsuquyomi#tsClient#stopTss()
  End
  ...
  It returns 0 when the file has a namespace
    call tsuquyomi#tsClient#tsOpen(s:input_file)
    let code = tsuquyomi#es6import#checkExternalModule('NS', s:input_file)
    Should code == 0
    call tsuquyomi#tsClient#stopTss()
  End
  ...
  It returns 0 when the file has an internal module
    call tsuquyomi#tsClient#tsOpen(s:input_file)
    let code = tsuquyomi#es6import#checkExternalModule('InternalModule', s:input_file)
    Should code == 0
    call tsuquyomi#tsClient#stopTss()
  End
